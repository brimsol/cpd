...
<!--=========breadcrumb start=========-->
<!--<div id="breadcrumb">
Home  >  <span class="color_change_b">Contact us</span>
</div>
<!--=========breadcrumb start=========-->
...
<h1>FAQ <?php if($this -> session -> userdata('username')!=''){?><a href="<?php echo site_url('admin/page/edit')?>/<?php echo $page  -> id; ?>"><img src="<?php echo base_url(); ?>/assets/images/edit.png" alt="Edit"></a> <?php }?></h1>
